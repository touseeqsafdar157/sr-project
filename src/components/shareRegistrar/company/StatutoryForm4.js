...
export const StatutoryForm4 = ({ data, formTemplate = false }) => {
    ...
    return (
        <div>
          ...
          <PDFExport
                ...
                margin="1cm"
                scale={0.6}
                fileName={`Statutory Requirment Form 4`}
            ...
            >
                ...
                <div className='row'>
                    <div className='col-md-12'>
                        ...
                        [Sections 26, 27, 28, 29 & 32 and Regulation 4]
                ...
                <div className='row'>
                    <div className='col-md-12' style={{ padding: '25px 50px', wordWrap: 'break-word' }}>
                        ...
                        <div className='d-flex  mt-2'>
                            ...
                            <ScrollWrapper className='align-items-center' style={{  width: '17.20%', paddingLeft: '20px', minHeight: '34px', borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212' }}></ScrollWrapper>
                        ...
                        <PartsWrapper className='mt-4 mb-3' style={{justifyContent: 'start'}}>
                        2.1 <span style={{paddingLeft: '15px'}}>	SECTION A — CHANGE IN PRINCIPAL LINE OF BUSINESS</span>
                        </PartsWrapper>

                        <div className='d-flex mt-2'>
                            <div className='align-items-center' style={{  paddingLeft: '2px', width: '7%' , borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212'}}>2.1.1</div>
                            <div className='align-items-center' style={{  width: '28%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212', minHeight: '55px' }}>Previous Principal line of business </div>
                            <div className='align-items-center' style={{ border: '1px solid #121212', width: '65%', padding: ' 5px 10px' }}> </div>
                        </div>
                        <div className='d-flex mt-2'>
                            <div className='align-items-center' style={{  paddingLeft: '2px', width: '7%' , borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212'}}>2.1.2</div>
                            <div className='align-items-center' style={{  width: '28%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212', minHeight: '55px' }}>New Principal line of business </div>
                            <div className='align-items-center' style={{ border: '1px solid #121212', width: '65%', padding: ' 5px 10px' }}> </div>
                        </div>
                        <div className='d-flex mt-2'>
                        ...
                        <div className='d-flex '>
                            <div className='align-items-center' style={{  paddingLeft: '2px', width: '7%', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}>2.1.3</div>
                            <div className='align-items-center' style={{  width: '51%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}>Date of change</div>
                        ...
                        <PartsWrapper className='mt-4 mb-3' style={{justifyContent: 'start'}}>
                        2.2 <span style={{paddingLeft: '15px'}}>	SECTION B — INTIMATION ABOUT PRINCIPAL LINE OF BUSINESS</span>
                        </PartsWrapper>
                        <div className='d-flex mt-2'>
                            <div className='align-items-center' style={{  paddingLeft: '2px', width: '7%' , borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212'}}>2.2.1</div>
                            <div className='align-items-center' style={{  width: '28%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderTop: '1px solid #121212', borderBottom: '1px solid #121212', minHeight: '100px' }}>Principal line of business 

(applicable if the object stated at serial number 1 of the object clause of memorandum is not the principal line of business of the company) </div>
                            <div className='align-items-center' style={{ border: '1px solid #121212', width: '65%', padding: ' 5px 10px' }}> </div>
                        </div>
                        ...
                        <div className='d-flex '>
                            <div className='align-items-center' style={{  paddingLeft: '2px', width: '7%', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}>2.2.2</div>
                            <div className='align-items-center' style={{  width: '51%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}>Date of change (if applicable)</div>
                            <div className='align-items-center' style={{ width: '5%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}> </div>
                            <div className='align-items-center' style={{  width: '5%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}> </div>
                            <div className='align-items-center' style={{  paddingLeft: '2px', width: '3%', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}></div>
                            <div className='align-items-center' style={{ width: '5%', padding: ' 5px 10px', borderLeft: '1px solid #121212', borderBottom: '1px solid #121212' }}> </div>
        ...
        <div className='mt-3 ml-5'>
            2.&nbsp;&nbsp;&nbsp;&nbsp; Amended/revised Copy of the Memorandum of Association  
             </div>
                    </div>
                </div>
                </div>

...
export default function AddShareCertificateIssuance({ setViewIssuePage }) {
  ...
  const createCertificate = async (data) => {
    ...
    console.log("🚀", updated_output_certificates)
    setLoading(true);
    try {
      setLoading(true);
      const response = await sendIssuanceCertificate(
        baseEmail,

...
export const Notifications = "Transactions";
...
// Task
export const Notification = "Transactions";
...
// SHARE REGISTRAR
export const SPLIT_SHARES = "Split Shares";
export const ISSUE_OF_SHARES = "Issue of Shares";
export const CONSOLIDATE_SHARES = "Consolidate Shares";
export const DUPLICATE_SHARES = "Duplicate Shares";
export const TRANSFER_OF_SHARES = "Transfer Of Shares";
export const ELECTRONIC_TRANSFER_OF_SHARES = "Electronic Transfer Of Shares";
export const PHYSICAL_TO_ELECTRONIC = "Physical To Electronic";
export const ELECTRONIC_TO_PHYSICAL = "Electronic To Physical";
export const RIGHT_SUBSCRIBTION = "Right Subscription";
export const TRANSFER_RIGHT_SHARES = "Transfer Right Shares";
export const VERIFICATION_TRANSFER_DEED = "Verification Transfer Deed";
export const TRANSMISSION_OF_SHARES = "Transmission Of Shares";
export const ELECTRONIC_TRANSMISSION_OF_SHARES =
  "Electronic Transmission Of Shares";
export const BONUS_SHARE_ALLOTMENT = "Bonus Share Allotment";
export const DIVIDEND_DISBURSEMENT = "Dividend Disbursement";
export const RIGHT_SHARE_ALLOTMENT = "Right Share Allotment";
export const INITIAL_PUBLIC_OFFERING_SUBSCRIPTION = "IPO Subscription";
export const INITIAL_PUBLIC_OFFERING_PAYMENT = "IPO Payment";

// EDIT INVESTOR REQUESTS
export const EDIT_SPLIT_SHARES = "Edit SPL";
export const EDIT_CONSOLIDATE_SHARES = "Edit CON";
export const EDIT_DUPLICATE_SHARES = "Edit DUP";
export const EDIT_TRANSFER_OF_SHARES = "Edit TOS";
export const EDIT_PHYSICAL_TO_ELECTRONIC = "Edit CEL";
export const EDIT_ELECTRONIC_TO_PHYSICAL = "Edit CPH";
export const EDIT_RIGHT_SUBSCRIBTION = "Edit RSUB";
export const EDIT_TRANSFER_RIGHT_SHARES = "Edit TOR";
export const EDIT_VERIFICATION_TRANSFER_DEED = "Edit VTD";
export const EDIT_TRANSMISSION_OF_SHARES = "Edit TRS";
export const EDIT_ELECTRONIC_TRANSFER_OF_SHARES = "Edit ETOS";
export const EDIT_ELECTRONIC_TRANSMISSION_OF_SHARES = "Edit ETRS";
export const EDIT_INITIAL_PUBLIC_OFFERING_SUBSCRIPTION =
  "Edit IPO Subscription";
export const EDIT_INITIAL_PUBLIC_OFFERING_PAYMENT = "Edit IPO Payment";

// TRANSACTIONS

// EDIT INVESTOR REQUESTS
export const SPLIT_SHARES_TEMPLATE = "SPL";
export const CONSOLIDATE_SHARES_TEMPLATE = "CON";
export const DUPLICATE_SHARES_TEMPLATE = "DUP";
export const TRANSFER_OF_SHARES_TEMPLATE = "TOS";
export const PHYSICAL_TO_ELECTRONIC_TEMPLATE = "CEL";
export const ELECTRONIC_TO_PHYSICAL_TEMPLATE = "CPH";
export const RIGHT_SUBSCRIBTION_TEMPLATE = "RSUB";
export const TRANSFER_RIGHT_SHARES_TEMPLATE = "TOR";
export const VERIFICATION_TRANSFER_DEED_TEMPLATE = "VTD";
export const TRANSMISSION_OF_SHARES_TEMPLATE = "TRS";
export const ELECTRONIC_TRANSMISSION_OF_SHARES_TEMPLATE = "ETRS";

export const BONUS_SHARE_ALLOTMENT_TEMPLATE = "BSA";
export const ELECTRONIC_TRANSFER_OF_SHARES_TEMPLATE = "ETOS";
export const DIVIDEND_DISBURSEMENT_TEMPLATE = "DIV";
export const RIGHT_SHARE_ALLOTMENT_TEMPLATE = "RSA";
export const ISSUE_OF_SHARES_TEMPLATE = "ISH";
export const INITIAL_PUBLIC_OFFERING_SUBSCRIPTION_TEMPLATE = "IPOSUB";
export const INITIAL_PUBLIC_OFFERING_PAYMENT_TEMPLATE = "IPOPAY";
